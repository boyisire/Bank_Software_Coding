...
static Table sgTables[] = 
{
  ...
  {12,10,"SWMSGPACK.CFG",MODE1},
  {13,4,"SWMONTERM.CFG",MODE1},
...
/******** swt_sys_task *********/  
 ...
 /******* swt_sys_route_m *********/
  ...
  /******** swt_sys_fmt_grp *******/
  /*modify short to long by zcd 2014/12/19*/
   /*delete by zcd 20141220
  {10,1,T_SHORT,"FMT_GROUP",0,3},
  ***end of delete by zcd 20141220*/
  /*add by zcd 20141220*/
  {10,1,T_LONG,"FMT_GROUP",0,3},
  /*end of add by zcd 20141220*/
...
/******* swt_sys_msgpack **********/
  ...
  {12,10,T_PCHAR,"ALERT_FLAG",2,0},
/******* swt_sys_ttytype *********/  
  {13,1,T_SHORT,"TERM_ID",0,3},
/*  {13,2,T_PCHAR,"TTYNAME",21,1},*/
 /* {13,3,T_PCHAR,"TFLAG",2,0},*/
  {13,2,T_PCHAR,"TERM_DESC",21,1},
  {13,3,T_PCHAR,"MSG_DESC",21,1},
  {13,4,T_PCHAR,"LEXPRESS",101,4},
/******** swt_sys_config **********/
  ...
  {16,5,T_SHORT,"OTHER_Q",0,0},
   ...
   /* delete by zjj 2002.07.30 */
   /*
   {19,10,T_PCHAR,"NEXT_FLAG",2,0},
   {19,11,T_SHORT,"PREREAD_LEN",0,0},
  */
   {19,10,T_PCHAR,"END_FLAG",21,0},
   {19,11,T_SHORT,"PREREAD_LEN",0,0},  /* add by zjj 2002.07.30 */
   {19,12,T_PCHAR,"MSGLEN_EXP",101,4},
   {19,13,T_PCHAR,"NEXT_EXPRESS",101,4},
   {19,14,T_PCHAR,"NEXT_FLAG",2,0},   /* add by zjj 2002.07.30 */
